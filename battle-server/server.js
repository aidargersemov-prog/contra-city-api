...
const BUILD_ID = "battle-server-2026-07-10-combat-contract-active-values-v249";
...
const APPLY_LEGACY_PROFILE_TEXT_BONUSES = process.env.APPLY_LEGACY_PROFILE_TEXT_BONUSES === "1";
...
function gameplayModifiersForProfile(profile = null) {
  ...
  if (!APPLY_LEGACY_PROFILE_TEXT_BONUSES) return modifiers;
