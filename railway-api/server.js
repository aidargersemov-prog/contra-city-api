...
const API_BUILD_ID = "railway-api-2026-07-10-clan-accept-direct-pg-v35";
...
async function accountFromRequest(url) {
  ...
  const traceClanRequest = requestPage === "clan" && ["join", "inv", "accept", "reject"].includes(requestAction);
